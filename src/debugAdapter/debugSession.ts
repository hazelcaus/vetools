...
export class VeToolsDebugSession extends LoggingDebugSession {
    ...
    protected async launchRequest(
        ...
        await this.sendErrorIfFailed(response, async () => {
            ...
            console.debug("args.txHash:", args.txHash)
            await this._runtime.attach(args.txHash, Constants.truffle_temp_dir)
